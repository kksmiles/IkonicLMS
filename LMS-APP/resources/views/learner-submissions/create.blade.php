...
<div class="mt-8">
    <div class="mt-4">
        <div class="p-6 bg-white rounded-md shadow-md">
            <h2 class="text-xl text-gray-700 font-semibold capitalize">Submit assignment</h2>
            
            <form action="{{ route('learner-submissions.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
