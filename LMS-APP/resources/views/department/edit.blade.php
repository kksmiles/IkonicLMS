...
<div class="p-6 bg-white rounded-md shadow-md">
    ...
    <h3 class="text-blue-500 text-md mt-8"> 
        ...
        <a href="{{ route('departments.create') }}"> Add a new department </a> 
    </h3>
</div>
<div class="mt-8">
    <div class="mt-4">
        <div class="p-6 bg-white rounded-md shadow-md">
            <h2 class="text-xl text-gray-700 font-semibold capitalize">Add a new department</h2>
            ...
            <form action="{{ route('departments.update', $department->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-4">
                    <div>
                        ...
                        <input name="name" class="form-input w-full mt-2 rounded-md focus:border-indigo-600" type="text" value="{{$department->name}}" required>
                    </div>
                    ...
                    <div>
                        <label class="text-gray-700" for="departmentname">Description</label>
