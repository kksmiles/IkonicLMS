...
<div class="mt-8">
    <div class="mt-4">
        <div class="p-6 bg-white rounded-md shadow-md">
            ...
            <form action="{{ route('course-material-topics.update', $course_material_topic->id) }}" method="POST">
                @csrf
                @method('PATCH')
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-4">
                    ...
                    <div>
                        ...
                        <input name="title" class="form-input w-full mt-2 rounded-md focus:border-indigo-600" value="{{ $course_material_topic->title }}" type="text" required>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="" rows="5" class="form-input w-full mt-2 rounded-md focus:border-indigo-600">
                            {{ $course_material_topic->description }}
                        </textarea>
                    </div>
