            ...
            <form action="{{ route('courses.update', $course->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-4">
                    <div>
                        ...
                        <input name="title" class="form-input w-full mt-2 rounded-md focus:border-indigo-600" type="text" value="{{$course->title}}" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input name="start_date" class="form-input w-full mt-2 rounded-md focus:border-indigo-600" type="date" value="{{ $course->start_date }}" required>
                    </div>

                    <div>
                        <label class="text-gray-700" for="start_date">End Date</label>
                        <input name="end_date" class="form-input w-full mt-2 rounded-md focus:border-indigo-600" type="date" value="{{ $course->end_date }}" required>
                    </div>                    
                </div>
