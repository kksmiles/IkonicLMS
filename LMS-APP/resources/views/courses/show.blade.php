        ...
        <div class="flex items-center">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-x-20 gap-y-10 mt-5">
                ...
                <div class="grid grid-cols-2">
                    <div class="text-sm my-auto">
                        <p class="text-black text-lg leading-none">Start Date</p>
                        <p class="text-gray-600 text-base mt-5">{{ date('jS F Y', strtotime($course->start_date)) }}</p>
                    </div>
                    <div class="text-sm my-auto ml-8">
                        <p class="text-black text-lg leading-none">End Date</p>
                                            ...
                                            <div class="h-auto p-4 mx-2 text-left bg-white rounded shadow-xl md:max-w-xl md:p-6 lg:p-6 md:mx-0" @click.away="open = false">
                                                ...
                                                <div class="mt-5 sm:mt-6">
                                                    <span class="flex flex-row-reverse w-full rounded-md shadow-sm">
                                                        <button onclick="event.preventDefault(); document.getElementById('delete-form{{ $course_material->id }}').submit();" class="inline-flex justify-center w-2/6 px-4 py-2 text-white bg-red-600 rounded hover:bg-red-900">
                                                            Delete
                                                        </button>
                                                ...
                                                <form id="delete-form{{ $course_material->id }}" action="{{ route('course-materials.destroy', $course_material->id) }}" method="POST" class="hidden">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                                    ...
                                                    <div class="mt-5">
                                                        <div class="container flex mx-auto w-full items-center justify-center">
                                                            ...
                                                            <ul class="flex flex-col bg-gray-300 p-4">
                                                                ...
                                                                <a href="#" onclick="document.getElementById('assignmentForm').submit();">
                                                                    <li class="border-gray-400 flex flex-row mb-2">
                                                                        <div class="select-none cursor-pointer bg-gray-200 rounded-md flex flex-1 items-center p-4  transition duration-500 ease-in-out transform hover:-translate-y-1 hover:shadow-lg">
                                                                            <div class="flex flex-col rounded-md w-10 h-10 bg-gray-300 justify-center items-center mr-4">
                                                                        ...
                                                                        <form id="assignmentForm" action="{{ route('assignments.create') }}">
                                                                            @csrf
                                                                ...
                                                                <a href="#" onclick="document.getElementById('fileForm').submit();">
                                                                    <li class="border-gray-400 flex flex-row mb-2">
                                                                        <div class="select-none cursor-pointer bg-gray-200 rounded-md flex flex-1 items-center p-4  transition duration-500 ease-in-out transform hover:-translate-y-1 hover:shadow-lg">
                                                                            <div class="flex flex-col rounded-md w-10 h-10 bg-gray-300 justify-center items-center mr-4">
                                                                        ...
                                                                        <form id="fileForm" action="{{ route('course-materials.create') }}">
                                                                            @csrf
                                                                            <input type="hidden" value="{{ $course_material_topic->course_id }}" name="course_id">
                                                                            <input type="hidden" value="{{ $course_material_topic->id }}" name="topic">
                                                                        </form>
